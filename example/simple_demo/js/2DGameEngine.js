...
class GameEngine {
    ...
    constructor(args = gameEngineConstructorArguments) {
        ...
        this.imageBank = loadImages(args.images, (n) => {
...
class GameObject {
    ...
    position = new Vector();
    zIndex = 0;
    positionRenderOffset = new Vector();
    #rotation = 0;
...
class Input {
    ...
    #mouseIn = false;
    #mouseClickTimers = [new Timer(201), new Timer(201), new Timer(201)];
...
(function (NetworkEvents) {
    NetworkEvents[NetworkEvents["PEER_OPENED"] = 0] = "PEER_OPENED";
    NetworkEvents[NetworkEvents["PEER_CONNECTION"] = 1] = "PEER_CONNECTION";
    NetworkEvents[NetworkEvents["PEER_CLOSED"] = 2] = "PEER_CLOSED";
    NetworkEvents[NetworkEvents["PEER_DISCONNECT"] = 3] = "PEER_DISCONNECT";
    NetworkEvents[NetworkEvents["PEER_ERROR"] = 4] = "PEER_ERROR";
    NetworkEvents[NetworkEvents["HOST_P2P_OPENED"] = 5] = "HOST_P2P_OPENED";
    NetworkEvents[NetworkEvents["HOST_P2P_CLOSED"] = 6] = "HOST_P2P_CLOSED";
    NetworkEvents[NetworkEvents["HOST_P2P_RECEIVED_DATA"] = 7] = "HOST_P2P_RECEIVED_DATA";
    NetworkEvents[NetworkEvents["CLIENT_P2P_OPENED"] = 8] = "CLIENT_P2P_OPENED";
    NetworkEvents[NetworkEvents["CLIENT_P2P_CLOSED"] = 9] = "CLIENT_P2P_CLOSED";
    NetworkEvents[NetworkEvents["CLIENT_P2P_RECEIVED_DATA"] = 10] = "CLIENT_P2P_RECEIVED_DATA";
    NetworkEvents[NetworkEvents["HOSTING_START"] = 11] = "HOSTING_START";
    NetworkEvents[NetworkEvents["HOSTING_END"] = 12] = "HOSTING_END";
...
class Network {
     ...
     * @param callback
     */
    static addCallback(event, callback) {
...
export { GameEngine, GameScene, GameObject, Timer, FPSCounter, Input, Graph, Vector, Camera, Rectangle, Polygon, Segment, Ray, RayCastShadow, Path, Drawable, id, PseudoRandom, PerlinNoise, lerp, coserp, ImagePrinter, range, map, TextureMapper, Network, NetworkEvents };
